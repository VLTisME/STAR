...
\begin{table}[t]
  ...
  \begin{tabular}{lrrrr}
    ...
    STAR two-stage retrieval & \textbf{96.76} & \textbf{94.65} & \textbf{99.30} & \textbf{99.85} \\
    \bottomrule
  \end{tabular}
  \label{tab:main}
\end{table}

\todo{Add fixed postprocessing, component-ablation, and scale tables from the experiment ledger.}
