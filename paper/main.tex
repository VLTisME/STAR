...
% Review submission: replace ID=***** only after a workshop submission ID is assigned.
% Camera-ready: replace this line with \usepackage{eccv}, add the author block below,
% and update the workshop page-limit requirement before submission.
...
% Keep this anonymous for review. Camera-ready authors:
% Tuan Vo-Lan, Khanh Tran-Quoc, Phuc Nguyen-Ngoc, Thanh Vo-Thai
% University of Science, Vietnam National University Ho Chi Minh City
\author{Anonymous ECCVW AI City Challenge Submission}
...
the remaining candidates. Figure~\ref{fig:pipeline} will visualise the pipeline.
